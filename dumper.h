...
void dump_syscall_unimplemented(Capio &c, Process &p, struct user_regs_struct &regs);
...
void dump_io(Capio &c, Process &p, struct user_regs_struct &regs, long long mem, ssize_t len);
